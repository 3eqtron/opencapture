 ...
 * @author .....
 */
class CommunicationsAbstract extends \Maarch\BusinessComponents\BusinessEntityAbstract implements \JsonSerializable
{
    ...
    {
        $this->__set('contactId', $communication);
    }
