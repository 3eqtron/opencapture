...
interface EventFormatInterface
{
     ...
     * @param MaarchRM\Business\Events\Entities\EventFormat $event The event format
     */
     ...
     *
     * @return MaarchRM\Business\Events\Entities\EventFormat
     */
     ...
     * @param string $roleName The type
     */
